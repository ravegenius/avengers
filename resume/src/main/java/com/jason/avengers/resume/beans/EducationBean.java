...
import static com.jason.avengers.common.configs.ItemViewType.EDUCATION;
...
public class EducationBean extends BaseItemBean {
    ...
    public static final int ItemViewType = EDUCATION;
    ...
    public static BaseItemViewHolder onCreateViewHolder(ViewGroup parent) {
        return new BaseItemViewHolder(parent, R.layout.resume_layout_item_view_education_info);
    }
