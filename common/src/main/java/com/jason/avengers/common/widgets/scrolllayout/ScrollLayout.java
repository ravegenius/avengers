...
package com.jason.avengers.common.widgets.scrolllayout;
...
import com.jason.avengers.common.widgets.scrolllayout.contentview.ContentScrollView;
...
public class ScrollLayout extends FrameLayout {
    ...
    private ContentScrollView.OnScrollChangedListener mOnScrollViewChangedListener = new ContentScrollView.OnScrollChangedListener() {
        @Override
        public void onScrollChanged(int l, int t, int oldL, int oldT) {
            if (null == mContentScrollView) return;
            if (null != onScrollChangedListener)
                onScrollChangedListener.onChildScroll(oldT);
            if (mContentScrollView.getScrollY() == 0) {
                setDraggable(true);
            } else {
                setDraggable(false);
            }
    ...
    private void updateRecyclerViewScrollState(RecyclerView recyclerView) {
        if (recyclerView.getChildCount() == 0) {
            ...
            if (layoutManager instanceof LinearLayoutManager || layoutManager instanceof GridLayoutManager) {
                i[0] = ((LinearLayoutManager) layoutManager).findFirstCompletelyVisibleItemPosition();
            } else if (layoutManager instanceof StaggeredGridLayoutManager) {
                i = null;
                i = ((StaggeredGridLayoutManager) layoutManager).findFirstCompletelyVisibleItemPositions(i);
            }
            if (i[0] == 0) {
    ...
    public void setAssociatedScrollView(ContentScrollView scrollView) {
        ...
        this.mContentScrollView.setScrollbarFadingEnabled(false);
        this.mContentScrollView.setOnScrollChangeListener(mOnScrollViewChangedListener);
    }
