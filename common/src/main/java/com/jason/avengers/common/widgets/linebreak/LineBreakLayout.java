package com.jason.avengers.common.widgets.linebreak;
 ...
 * 自动换行View
 */
public class LineBreakLayout extends ViewGroup implements Observer {

    private final static String TAG = "LineBreakLayout";

    private LineBreakAdapter mAdapter;
    ...
    public LineBreakAdapter getAdapter() {
        return mAdapter;
    }

    public void setAdapter(LineBreakAdapter adapter) {
        mAdapter = adapter;
        if (mAdapter != null) mAdapter.addObserver(this);
        resetViews();
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mAdapter != null) mAdapter.deleteObserver(this);
    }
