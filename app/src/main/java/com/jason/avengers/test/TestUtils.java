package com.jason.avengers.test;

import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;
import com.jason.avengers.base.BaseItemBean;
import com.jason.avengers.education.beans.EducationBean;
...
public class TestUtils {
    ...
    public static List<BaseItemBean> initSkillTestData() {
        ...
        String skillJson = "[" +
                ...
                "\"Activity\", \"Service\", \"Content Provider\", \"Broadcast Receiver\", \"Fragment\", \"Intent\", \"Handler\", \"Toast\", \"Menu\", \"ViewGroup & View\", \"ViewStub\", \"RecyclerView\", \"Permission\", " +
                "\"多级缓存\", \"文件存储\", \"SharedPreferences\", \"SQLite数据库存储\", \"LitePal操作数据库\", \"多媒体-视频&相机\", \"网络技术\", \"WebView\", \"Android多线程编程\", \"Material Design UI\", \"Log\", \"Nine-Patch\", " +
    ...
    public static UserBean initUserTestData() {
        ...
        String userJson = "{\"id\":1, \"name\":\"Jason\", \"sex\":1, \"age\":33, \"workAge\":10, \"avatar\":\"https://tvax4.sinaimg.cn/crop.0.0.1080.1080.180/64b3acc7ly8fqmet0ddb1j20u00u0jw2.jpg\", \"email\":\"ravegenius1985@126.com\", \"phone\":\"13401073452\"}";
