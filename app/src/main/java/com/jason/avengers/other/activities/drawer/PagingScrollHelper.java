...
public class PagingScrollHelper {
    ...
    public class MyOnFlingListener extends RecyclerView.OnFlingListener {
        ...
        public boolean onFling(int velocityX, int velocityY) {
            System.out.println("PagingScrollHelper=="
                    + ">>" + velocityX
                    + ">>" + velocityY);
            if (mOrientation == ORIENTATION.NULL) {
                return false;
            ...
            if (Math.abs(startPoint - endPoint) > 100) {
                mAnimator.start();
            }
            ...
            if (newState == 0 && mOrientation != ORIENTATION.NULL) {
                ...
                if (mOrientation == ORIENTATION.VERTICAL) {
                    ...
                    System.out.println("PagingScrollHelper=="
                            + ">>" + offsetX + ">>" + startX
                            + ">>" + offsetY + ">>" + startY
                            + ">>" + move + ">>" + recyclerView.getWidth() / 2
                    );
                }

                System.out.println("PagingScrollHelper==" + ">>" + vX + ">>" + vY);
    ...
    public class MyOnTouchListener implements View.OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            System.out.println("PagingScrollHelper==" + ">>onTouch");
            //手指按下的时候记录开始滚动的坐标
            if (firstTouch) {
