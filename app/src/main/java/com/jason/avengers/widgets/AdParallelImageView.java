package com.jason.avengers.widgets;
...
//            drawableBoundTopY = 0;
     ...
     * @param recyclerView
     */
    public static void compute(@NonNull RecyclerView recyclerView) {
        if (null != recyclerView.getLayoutManager() && recyclerView.getLayoutManager() instanceof LinearLayoutManager) {
            ...
            if (null != linearLayoutManager) {
                ...
                for (int i = fPos; i <= lPos; i++) {
                    ...
                    AdParallelImageView adImageView = view.findViewById(R.id.adParallelImageView);
                    if (null != adImageView) {
