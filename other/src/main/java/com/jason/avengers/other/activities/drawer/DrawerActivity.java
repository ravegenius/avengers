...
public class DrawerActivity extends BaseNoMVPActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.other_activity_drawer);
        initView();
    }

    private void initView() {
        mPaddingLeftAndRight = (int) (Utils.Screen.getScreenWidth(this) * 0.05f);
        mScaleMax = 1.f - ((float) mPaddingLeftAndRight * 2.0000f + (float) mPageMargin) / (float) Utils.Screen.getScreenWidth(this);
        ...
        mScrollLayout.setMaxOffset((int) (Utils.Screen.getScreenHeightWithoutStatusBar(this) * DrawerConfigs.DrawerOffset));
        mScrollLayout.setExitOffset(Utils.Dimen.dp2px(this, 50));
